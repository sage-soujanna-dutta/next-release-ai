...
async function generateCombinedSprintSummary1920() {
  console.log('🎯 Combined Sprint Summary Generation');
  console.log('📊 Analyzing SCNT-2025-19 & SCNT-2025-20');
  ...
  try {
    ...
    console.log('📊 Target Sprints: SCNT-2025-19, SCNT-2025-20');
    ...
    console.log('');
    console.log('🏆 Analysis Focus: Performance comparison between SCNT-2025-19 and SCNT-2025-20');
...
generateCombinedSprintSummary1920().catch(console.error);
