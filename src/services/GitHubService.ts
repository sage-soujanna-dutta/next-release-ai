...
export class GitHubService {
  ...
  async fetchCommits(date?: string, branch?: string): Promise<GitHubCommit[]> {
    try {
  ...
  async fetchAllCommitsFromBranch(branch: string, maxCommits: number = 1000): Promise<GitHubCommit[]> {
    try {
  ...
  async fetchCommitsForDateRange(startDate: string, endDate: string): Promise<GitHubCommit[]> {
    try {
